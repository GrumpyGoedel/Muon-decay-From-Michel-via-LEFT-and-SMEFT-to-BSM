...
def main():
    ...
    lines = ["# Muon-decay constraints on LEFT Wilson coefficients",
             ...
             "coefficients `x = v² c ~ (v/Λ)²`; bounds at 95% CL. Likelihood "
             "is the block-covariance χ² of `main.tex` "
             "(TWIST 3×3 + Danneberg 4×4 + ξ' + ξ''), plus a G_F normalization "
             "block. See `leftfit/observables.py`._", ""]

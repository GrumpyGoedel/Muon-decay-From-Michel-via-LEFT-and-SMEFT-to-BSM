...
From the LEFT paper by Jenkins, Manohar \& Stoffer \parencite{jenkins2018lowOM} on operators and matching at dimension six we collect the following matching conditions for the LNC operators $\mathcal{O}^{V,LL}_{\nu e}$ and $\mathcal{O}^{V,LR}_{\nu e}$:
\begin{align}
...
For the scalar and tensor operators, since they violate lepton number, the matching at dimension six is zero but at dimension seven we get from \parencite{liao2020extending}:
\begin{align}

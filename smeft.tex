...
\begin{equation}
    \mathcal{L}^5=C_5^{rs}\epsilon ^{ij}\epsilon^{kl}(l^T_{ir}Cl_{ks})H_jH_l+\text{h.c.}
\end{equation}
...
\begin{align}
    L^{V,LL}_{\nu e,ab12}=\; &C_{ll}^{ab12}+C_{ll}^{12ab}-\tfrac{\bar g_2^2}{2M_W^2}\left(\delta_{a2}\delta_{b1}+\delta_{a2}v_T^2C^{(3),b1}_{Hl}+\delta_{b1}v_T^2C^{(3),a2}_{Hl}\right)\label{eq:LVLLmatching}\\[5pt]

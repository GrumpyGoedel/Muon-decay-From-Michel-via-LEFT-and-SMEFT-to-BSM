...
For the TWIST measurement, we use the following native parameter basis:
\begin{equation}
...
independent. The same applies to $\alpha'/A$ and $\beta'/A$. Indeed both pairs are separately strongly correlated. 
